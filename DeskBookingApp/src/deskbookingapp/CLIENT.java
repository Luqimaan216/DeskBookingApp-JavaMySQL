...
public class CLIENT {
    ...
    //create a fucntion to add a client
    ...
    //creata a fucntiom to edit the selected client
    ...
    //create a function to remove a selected client
    ...
    //create a function to populate the jTable with all the cleints in the database
